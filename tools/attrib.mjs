...
var probe = process.argv[3] ?? "The Eiffel Tower is located in the city of";
...
var prev = new Float32Array(nLens);
for (let l = 0; l < L; l++) {
...
var winner = m.lensPieces.findIndex((p) => p === " Paris");
if (winner >= 0) {
  console.log(`
